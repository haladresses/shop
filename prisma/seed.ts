...
async function main() {
  ...
  const settings = [
    ...
    { key: "store_phone", value: "+968 9944 0312", group: "general", labelEn: "Store Phone" },
    { key: "store_address", value: "Bousher, Muscat, Oman", group: "general", labelEn: "Address" },
    { key: "store_instagram", value: "7ala_dresses", group: "general", labelEn: "Instagram" },
    { key: "store_map_url", value: "https://maps.app.goo.gl/BSc5jipKCdqdDHEM8", group: "general", labelEn: "Map URL" },
