  ...
  columns: [
    {
      ...
      titleAr: "الحساب",
      links: [
        { labelEn: "My Account", labelAr: "حسابي", href: "/my-account" },
        { labelEn: "Client Login", labelAr: "تسجيل الدخول", href: "/signin" },
        { labelEn: "Shopping Bag", labelAr: "سلة التسوق", href: "/cart" },
        { labelEn: "Wishlist", labelAr: "المفضلة", href: "/wishlist" },
        { labelEn: "Collections", labelAr: "التشكيلات", href: "/shop" },
      ],
    },
    {
      titleEn: "Client Care",
      titleAr: "دعم العملاء",
      links: [
        { labelEn: "Privacy Policy", labelAr: "الخصوصية", href: "/privacy-policy" },
        { labelEn: "Refund Policy", labelAr: "الاسترجاع", href: "/refund-policy" },
        { labelEn: "Terms of Use", labelAr: "شروط الاستخدام", href: "/terms-of-use" },
        { labelEn: "FAQ\u2019s", labelAr: "الأسئلة الشائعة", href: "/faq" },
