...
export type AdminHelpTopicArabic = {
  ...
  outcomes: string[];
  guidance: string[];
  /** Arabic translation of the ordered workflow steps (optional, falls back to English). */
  steps?: string[];
  /** Arabic translation of the cautions (optional, falls back to English). */
  cautions?: string[];
};

export type AdminHelpQuickStartArabic = {
  title: string;
  description: string;
  steps: string[];
};

export type AdminHelpFaqArabic = {
  question: string;
  answer: string;
};
...
/**
 * Arabic translation of each topic's ordered steps and cautions, keyed by href.
 * Kept separate so the primary ADMIN_HELP_ARABIC entries stay compact; merged at render time.
 */
export const ADMIN_HELP_ARABIC_STEPS: Record<string, { steps: string[]; cautions: string[] }> = {
  "/admin": {
    steps: [
      "افتح لوحة التحكم في بداية كل وردية عمل.",
      "راجع بطاقات اتجاهات المبيعات والطلبات والعملاء بحثاً عن أي شذوذ.",
      "تحقق من الطلبات المعلقة وتنبيهات انخفاض المخزون.",
      "انقر على الطلب أو المنتج المتأثر لاتخاذ الإجراء المناسب.",
    ],
    cautions: [
      "الأرقام هنا ملخص فقط — لا تعدّل بيانات الكتالوج بناءً على قفزة في الاتجاه.",
      "المؤشر الذي يبدو غير صحيح غالباً ما يكون تأخيراً في مزامنة الدفع أو المخزون وليس بيانات خاطئة.",
    ],
  },
  "/admin/orders": {
    steps: [
      "ابحث عن الطلب بالرقم أو اسم العميل أو رقم الهاتف.",
      "تحقق من حالة الدفع وراجع عناصر الطلب.",
      "أكّد عنوان الشحن والطريقة المختارة.",
      "لا تنقل الحالة إلا بعد تأكيد الدفع والشحن معاً.",
    ],
    cautions: [
      "لا تعلّم الطلب كمُسلَّم قبل أن يكتمل الدفع.",
      "تحقق مرتين من بيانات التواصل لطلبات الضيوف قبل أي إجراء إرسال.",
    ],
  },
  "/admin/payments": {
    steps: [
      "حدد سجل الدفع من الطلب المرتبط به.",
      "أكّد الحالة: مدفوع أو غير مدفوع أو فاشل أو مسترد.",
      "نفّذ الاسترداد المدعوم فقط بعد الموافقة التشغيلية.",
      "لإعدادات البوابة، اضبط الوضع أولاً ثم الصق المفاتيح المطابقة.",
    ],
    cautions: [
      "مفاتيح البوابة أسرار — اقصر تعديلها على مسؤولي المدفوعات.",
      "لا تخلط أبداً بين بيانات UAT والإنتاج في الإعداد نفسه.",
    ],
  },
  "/admin/shipping": {
    steps: [
      "افتح شاشة إعدادات الشحن.",
      "عدّل توفر الفروع وتكاليف التوصيل.",
      "حدّث بطاقات الأسعار الدولية عند الحاجة.",
      "احفظ ثم أعد اختبار عملية دفع للتأكد من صحة الحسابات.",
    ],
    cautions: [
      "تعديلات الأسعار والفروع تغيّر إجماليات الدفع المباشرة — تحقق قبل الحفظ.",
      "تعامل مع بيانات Wasellee باعتبارها أسراراً وليست إعدادات عادية.",
    ],
  },
  "/admin/coupons": {
    steps: [
      "أنشئ كوبوناً برمز واضح وسهل التذكر.",
      "اختر خصماً ثابتاً أو نسبياً.",
      "اضبط الحد الأدنى للطلب وتاريخ الانتهاء وحد الاستخدام.",
      "راجع القائمة النشطة قبل إطلاق الحملة.",
    ],
    cautions: [
      "احسب الأثر المالي للخصومات الكبيرة قبل التفعيل.",
      "تجنّب الرموز المتداخلة التي قد تتراكم بطرق غير متوقعة.",
    ],
  },
  "/admin/users": {
    steps: [
      "ابحث عن الحساب الموجود أو أنشئ حساباً جديداً.",
      "اضبط بيانات الملف الشخصي والتواصل.",
      "عيّن الدور الذي يطابق مسؤوليات الشخص.",
      "استخدم التعطيل بدل الحذف عند الشك.",
    ],
    cautions: [
      "تغييرات الأدوار تُطبَّق فوراً عبر القوائم وواجهات API المحمية.",
      "فضّل التعطيل على الحذف للحسابات المرتبطة بطلبات سابقة.",
    ],
  },
  "/admin/contact": {
    steps: [
      "افتح تبويب صندوق الوارد وصفِّ حسب الجديد لرؤية الرسائل غير المعالجة.",
      "تواصل مع العميل عبر الهاتف أو الواتساب أو البريد ثم علّم الرسالة كمقروءة.",
      "أرشف أو احذف الرسائل التي لم تعد بحاجة إليها.",
      "استخدم تبويب بيانات التواصل لتحديث الهاتف والعنوان وروابط التواصل العامة.",
    ],
    cautions: [
      "حذف الرسالة نهائي — أرشفها بدلاً من ذلك عند الشك.",
      "بيانات التواصل هنا عامة وتظهر في كل الموقع؛ تحقق منها قبل الحفظ.",
    ],
  },
  "/admin/products": {
    steps: [
      "أنشئ منتجاً جديداً أو افتح منتجاً موجوداً.",
      "أدخل العنوان والسعر والرمز والصور.",
      "اضبط المتغيرات والخصائص الخاصة بالفئة.",
      "لا تنشر إلا بعد التحقق من كل حقل.",
    ],
    cautions: [
      "تغيير الفئة قد يبدّل الخصائص المطلوبة — أعد مراجعتها.",
      "لا تنشر منتجاً بصور أو مخزون ناقص.",
    ],
  },
  "/admin/categories": {
    steps: [
      "ابنِ شجرة الفئات الرئيسية والفرعية.",
      "عرّف الخصائص مثل الخامة أو اللون أو المقاس.",
      "اضبط ترتيب العرض وحالة الظهور لكل عنصر.",
      "تأكد من ارتباط المنتجات بالفئات الصحيحة.",
    ],
    cautions: [
      "لا تحذف فئات تحتوي منتجات أو فئات فرعية بدون خطة نقل.",
      "حافظ على ثبات مفاتيح الخصائص بمجرد اعتماد المنتجات عليها.",
    ],
  },
  "/admin/inventory": {
    steps: [
      "ابحث عن المنتج وافتح قائمة متغيراته.",
      "تأكد أنك تعدّل المقاس واللون الصحيحين.",
      "سجّل التعديل مع سبب تجاري واضح.",
      "راجع التوفر الناتج على صفحة المنتج.",
    ],
    cautions: [
      "معظم أخطاء المخزون تأتي من تعديل المتغير الخاطئ.",
      "كل تصحيح يجب أن يحمل سبباً قابلاً للمراجعة.",
    ],
  },
  "/admin/reviews": {
    steps: [
      "افتح قائمة التقييمات المعلقة.",
      "اقرأ كل تقييم وفق سياسة الإشراف.",
      "اقبله أو ارفضه بشكل متسق.",
      "وجّه مشاكل المنتج الحقيقية إلى الكتالوج أو العمليات.",
    ],
    cautions: [
      "الإشراف غير المتسق يقوّض الثقة في نظام التقييمات.",
      "إخفاء تقييم لا يحل مشكلة المنتج الأساسية.",
    ],
  },
  "/admin/hero": {
    steps: [
      "افتح محرر الواجهة الرئيسية.",
      "حدّث العنوان ودعوة الإجراء والصور.",
      "عاين النتيجة على الجوال وسطح المكتب.",
      "نسّق التوقيت مع أقسام البانر والعد التنازلي.",
    ],
    cautions: [
      "أبقِ النص قصيراً حتى تبقى الواجهة مقروءة على الجوال.",
      "أعد فحص قص الصور بعد أي تعديل تصميمي كبير.",
    ],
  },
  "/admin/promo-banner": {
    steps: [
      "افتح محرر بانر العروض.",
      "اكتب رسالة عرض مختصرة ذات تركيز واحد.",
      "انشر وأكّد ظهورها في المتجر.",
      "جدول استبدالها أو إزالتها.",
    ],
    cautions: [
      "النص الطويل ينافس بقية الصفحة على الانتباه.",
      "أكّد توقيت الانتهاء مع مسؤول الحملة.",
    ],
  },
  "/admin/countdown": {
    steps: [
      "افتح إعدادات عرض العد التنازلي.",
      "اضبط تفاصيل العرض ووقت الانتهاء المستهدف.",
      "تحقق من المنطقة الزمنية قبل الحفظ.",
      "اربطه بإبراز منتجات مطابقة في الصفحة الرئيسية.",
    ],
    cautions: [
      "أكّد دائماً وقت الانتهاء في المنطقة الزمنية المقصودة.",
      "أزل العدادات المنتهية بسرعة لحماية الثقة.",
    ],
  },
  "/admin/testimonials": {
    steps: [
      "افتح إدارة الشهادات.",
      "أضف أو عدّل الاقتباس والنسبة وترتيب العرض.",
      "تحقق من الترجمة إذا استُخدم حقلا اللغتين.",
      "احفظ وعاين النتيجة في المتجر.",
    ],
    cautions: [
      "أبقِ الشهادات واقعية وواضحة النسبة.",
      "راجع جودة الترجمة قبل النشر.",
    ],
  },
  "/admin/newsletter": {
    steps: [
      "افتح لوحة النشرة البريدية.",
      "راجع قوائم المشتركين ونشاط الاكتساب.",
      "صدّر الجمهور بحذر عند الحاجة.",
      "أكّد أن التقاط الاشتراكات يعمل في المتجر.",
    ],
    cautions: [
      "بيانات المشتركين بيانات عملاء — احرص عند التصدير.",
      "اجعل عمليات التنظيف مدروسة حتى تبقى التقارير مفيدة.",
    ],
  },
  "/admin/legal-pages": {
    steps: [
      "افتح الصفحة القانونية التي تريد تعديلها.",
      "عدّل نص السياسة أو الشروط أو الإفصاح.",
      "واءم الصياغة مع سلوك الدفع والشحن والإرجاع الفعلي.",
      "انشر بعد مراجعة صاحب القرار.",
    ],
    cautions: [
      "نسّق الصياغة القانونية مع أصحاب القرار قبل النشر.",
      "راجع سياسات الاسترجاع والخصوصية كلما تغيّرت العمليات.",
    ],
  },
  "/admin/navigation": {
    steps: [
      "افتح محرر قائمة التنقل.",
      "أضف الروابط أو أعد ترتيبها أو احذفها.",
      "تأكد أن كل وجهة موجودة ومرئية.",
      "أبقِ المستوى الأعلى مركّزاً على الأولويات.",
    ],
    cautions: [
      "الروابط المكسورة تضر بثقة التنقل — اختبر كل وجهة.",
      "تجنّب تكديس المستوى الأعلى بخيارات متنافسة.",
    ],
  },
  "/admin/settings": {
    steps: [
      "افتح إعدادات المتجر.",
      "حدّث قيم التواصل أو الدفع أو التذييل.",
      "راجع الأثر الواسع للتغيير.",
      "احفظ ثم افحص الصفحات المتأثرة.",
    ],
    cautions: [
      "إعدادات المتجر العامة قد تغيّر عدة صفحات دفعة واحدة.",
      "استخدم أقسام Payments وShipping للإعدادات الحساسة الخاصة بالتكاملات.",
    ],
  },
  "/admin/roles": {
    steps: [
      "افتح الأدوار والصلاحيات.",
      "اختر الدور الذي تريد تعديله.",
      "افتح أو قيّد أقساماً وإجراءات محددة.",
      "راجع الوصول الفعلي قبل الإنهاء.",
    ],
    cautions: [
      "تغييرات الصلاحيات تُطبَّق فوراً على المناطق المحمية.",
      "صمّم الوصول وفق سير العمل الحقيقي وليس الافتراضات.",
    ],
  },
  "/admin/help": {
    steps: [
      "افتح مركز المساعدة.",
      "ابحث أو صفِّ للوصول إلى القسم الذي تحتاجه.",
      "اتبع خطواته وإرشاداته وتحذيراته.",
      "اقرنه مع الأدوار والصلاحيات عند تصميم الأدوار.",
    ],
    cautions: [
      "غياب قسم يعني عادةً أن الدور لا يملك صلاحيته.",
      "استخدمه مع الأدوار والصلاحيات لتشكيل تجربة كل دور.",
    ],
  },
};

export const ADMIN_HELP_QUICK_START_ARABIC: Record<string, AdminHelpQuickStartArabic> = {
  "/admin": {
    title: "تهيئة مشغّل جديد",
    description: "امنح عضو الفريق الجديد بداية آمنة ومركّزة في يومه الأول.",
    steps: [
      "أنشئ حسابه ضمن المستخدمين وعيّن الدور المناسب.",
      "تأكد أنه يرى فقط الأقسام التي يسمح بها دوره.",
      "وجّهه إلى لوحة التحكم للمتابعة اليومية.",
      "اطلب منه قراءة أدلة كل قسم يتولّاه.",
    ],
  },
  "/admin/orders": {
    title: "معالجة طلب من البداية للنهاية",
    description: "انقل الطلب من الإنشاء إلى التسليم بدون أخطاء.",
    steps: [
      "تحقق من اكتمال الدفع ضمن المدفوعات.",
      "أكّد عنوان الشحن والطريقة.",
      "أرسل الطلب وحدّث حالة الشحن.",
      "علّمه مُسلَّماً فقط بعد تأكيد الدفع والشحن.",
    ],
  },
  "/admin/hero": {
    title: "إطلاق حملة على الصفحة الرئيسية",
    description: "نسّق واجهات المتجر لعرض ترويجي.",
    steps: [
      "حدّث الواجهة الرئيسية برسالة الحملة.",
      "أضف بانر عروض للعرض الداعم.",
      "جدول عرض عد تنازلي لخلق الإلحاح.",
      "أنشئ كوبونات مطابقة وتحقق من حساب الخصم.",
    ],
  },
  "/admin/products": {
    title: "نشر منتج جديد",
    description: "أضف منتجاً مكتملاً ومصنّفاً بشكل صحيح.",
    steps: [
      "تأكد من وجود الفئة وخصائصها.",
      "أنشئ المنتج بالصور والأسعار والرمز.",
      "اضبط مخزون المتغيرات ضمن المخزون.",
      "انشر فقط بعد التحقق من كل حقل.",
    ],
  },
};

export const ADMIN_HELP_FAQ_ARABIC: AdminHelpFaqArabic[] = [
  {
    question: "لماذا لا أرى قسماً يراه زميلي؟",
    answer:
      "يتم تصفية مركز المساعدة وقائمة الإدارة حسب الصلاحيات. إذا غاب قسم، فإن دورك لا يملك صلاحية الوصول إليه حالياً. اطلب من المسؤول مراجعة دورك ضمن الأدوار والصلاحيات.",
  },
  {
    question: "هل تُطبّق تغييرات الصلاحيات فوراً؟",
    answer:
      "نعم. بمجرد تحديث الدور ضمن الأدوار والصلاحيات، يُطبّق التغيير مباشرة على القوائم والصفحات وواجهات API المحمية. حدّث الصفحة لرؤية التنقل المُحدّث.",
  },
  {
    question: "أين أغيّر بيانات الدفع أو الشحن؟",
    answer:
      "مفاتيح التكامل الحساسة موجودة في أقسام المدفوعات والشحن المخصصة وليست في الإعدادات العامة. فقط من يملك صلاحية الإدارة المطابقة يعدّلها، ويجب عدم خلط مفاتيح UAT والإنتاج أبداً.",
  },
  {
    question: "كيف أزيل مستخدماً غادر العمل؟",
    answer:
      "فضّل التعطيل على الحذف عندما يكون الحساب مرتبطاً بطلبات سابقة أو سجلات تشغيلية. الحذف آمن فقط عندما لا يعتمد عليه أي شيء.",
  },
  {
    question: "ما الفرق بين الإرشادات والتحذيرات في الدليل؟",
    answer:
      "تصف الإرشادات الطريقة الموصى بها لتشغيل القسم. أما التحذيرات فتبرز الأخطاء الشائعة والإجراءات الخطرة التي تسبب أكثر مشاكل الدعم، لذا راجع الاثنين قبل التنفيذ.",
  },
  {
    question: "هل يمكنني تعديل المتجر بدون نشر كود؟",
    answer:
      "نعم. الواجهات المحتوائية مثل الواجهة الرئيسية وبانر العروض والعد التنازلي والشهادات والتنقل والصفحات القانونية كلها قابلة للتعديل من الإدارة بدون إصدار كود جديد.",
  },
];

export const ADMIN_HELP_CATEGORY_ARABIC: Record<
  AdminHelpTopic["category"],
  { label: string; eyebrow: string; description: string }
> = {
  Operations: {
    label: "العمليات",
    eyebrow: "التنفيذ",
    description: "سير العمل اليومي للطلبات والمدفوعات والشحن والعملاء والعمليات التجارية.",
  },
  Catalog: {
    label: "الكتالوج",
    eyebrow: "العرض التجاري",
    description: "بنية المنتجات ودقة المخزون وإدارة التقييمات التي تحافظ على صحة المتجر.",
  },
  Content: {
    label: "المحتوى",
    eyebrow: "التجربة",
    description: "الصفحة الرئيسية والحملات والرسائل والواجهات التحريرية التي تشكّل عرض المتجر.",
  },
  Platform: {
    label: "المنصة",
    eyebrow: "التحكم",
    description: "الضوابط الإدارية وقواعد النظام والصلاحيات والإعدادات على مستوى المنصة.",
  },
};

export const ADMIN_HELP_LEVEL_ARABIC: Record<AdminHelpLevel, string> = {
  Core: "أساسي",
  Advanced: "متقدم",
  Sensitive: "حساس",
};

/** All static UI strings for the Help Center, per language. */
export const ADMIN_HELP_UI = {
  en: {
    dir: "ltr" as const,
    langName: "English",
    switchTo: "العربية",
    documentTitle: "Admin Help Center",
    heroTitle: "A precise, role-aware guide to running the store",
    heroSubtitle:
      "Every guide explains the purpose of a section, the actions it supports, the exact steps to complete common tasks, and the cautions that prevent costly mistakes. Content is filtered by permission, so you only ever see guidance for the screens you can actually use.",
    downloadPdf: "Download PDF",
    downloadEnPdf: "English PDF",
    downloadArPdf: "Arabic PDF",
    quickStartTitle: "Guided quick starts",
    quickStartSubtitle: "Common end-to-end workflows, broken into safe, ordered steps.",
    goTo: "Go to",
    section: "section",
    requiresPermission: "Requires additional permission",
    permissionNotePrefix: "If a guide is missing here, that role does not currently have permission to access that section. Use the",
    rolesLink: "Roles & Permissions",
    permissionNoteSuffix: "screen to expand or narrow what each team can see and do.",
    ...
    noMatchTitle: "No matching help topics",
    noMatchBody: "Try a broader search term, or clear the filters to see every guide.",
    clearFilters: "Clear filters",
    openSection: "Open section",
    enlarge: "Enlarge",
    previewUnavailable: "Preview unavailable",
    relatedSections: "Related sections",
    tabs: { overview: "Overview", steps: "Steps", guidance: "Guidance", cautions: "Cautions" },
    faqTitle: "Frequently asked questions",
    faqSubtitle: "Quick answers to the questions operators ask most often.",
    supportTitle: "Still need a hand?",
    supportBody:
      "Pair this Help Center with the Roles & Permissions screen to design a focused experience for each team, or reach your platform administrator for access changes.",
    manageRoles: "Manage roles",
    printGenerated: "Generated from the Admin Help Center",
    printPage: "Page",
    popupBlocked: "Please allow pop-ups for this site to download the PDF.",
  },
  ar: {
    dir: "rtl" as const,
    langName: "العربية",
    switchTo: "English",
    documentTitle: "مركز مساعدة الإدارة",
    heroTitle: "دليل دقيق وواعٍ بالصلاحيات لإدارة المتجر",
    heroSubtitle:
      "يشرح كل دليل الغرض من القسم والإجراءات التي يدعمها والخطوات الدقيقة لإنجاز المهام الشائعة والتحذيرات التي تمنع الأخطاء المكلفة. يُصفّى المحتوى حسب الصلاحية، لذا لن ترى إلا إرشادات الشاشات التي يمكنك استخدامها فعلاً.",
    downloadPdf: "تنزيل PDF",
    downloadEnPdf: "PDF بالإنجليزية",
    downloadArPdf: "PDF بالعربية",
    quickStartTitle: "بدايات سريعة موجّهة",
    quickStartSubtitle: "سير عمل شائع من البداية للنهاية مقسّم إلى خطوات آمنة ومرتبة.",
    goTo: "انتقل إلى",
    section: "القسم",
    requiresPermission: "يتطلب صلاحية إضافية",
    permissionNotePrefix: "إذا غاب دليل هنا، فإن ذلك الدور لا يملك حالياً صلاحية الوصول إلى ذلك القسم. استخدم شاشة",
    rolesLink: "الأدوار والصلاحيات",
    permissionNoteSuffix: "لتوسيع أو تضييق ما يمكن لكل فريق رؤيته وتنفيذه.",
    ...
    showing: "عرض",
    of: "من",
    visibleGuides: "دليلاً مرئياً.",
    noMatchTitle: "لا توجد مواضيع مساعدة مطابقة",
    noMatchBody: "جرّب كلمة بحث أوسع أو امسح الفلاتر لرؤية كل الأدلة.",
    clearFilters: "مسح الفلاتر",
    openSection: "افتح القسم",
    enlarge: "تكبير",
    previewUnavailable: "المعاينة غير متوفرة",
    relatedSections: "الأقسام ذات الصلة",
    tabs: { overview: "نظرة عامة", steps: "الخطوات", guidance: "الإرشادات", cautions: "التحذيرات" },
    faqTitle: "الأسئلة الشائعة",
    faqSubtitle: "إجابات سريعة عن الأسئلة الأكثر تكراراً بين المشغّلين.",
    supportTitle: "ما زلت بحاجة إلى مساعدة؟",
    supportBody:
      "اقرن مركز المساعدة هذا مع شاشة الأدوار والصلاحيات لتصميم تجربة مركّزة لكل فريق، أو تواصل مع مسؤول المنصة لتغييرات الوصول.",
    manageRoles: "إدارة الأدوار",
    printGenerated: "مُنشأ من مركز مساعدة الإدارة",
    printPage: "صفحة",
    popupBlocked: "يرجى السماح بالنوافذ المنبثقة لهذا الموقع لتنزيل ملف PDF.",
  },
} as const;

export type AdminHelpLang = keyof typeof ADMIN_HELP_UI;