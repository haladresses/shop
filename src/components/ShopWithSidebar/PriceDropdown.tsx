...
const PriceDropdown = ({ title, currency, min, max, value, onChange }: PriceDropdownProps) => {
  const [toggleDropdown, setToggleDropdown] = useState(true);

  // Guard against an invalid range (e.g. all products at the same price).
        ...
        <div id="pricingOne">
          <div className="price-range">
            <RangeSlider
              ...
              onInput={(e: number[]) => onChange(Math.floor(e[0]), Math.ceil(e[1]))}
            />
